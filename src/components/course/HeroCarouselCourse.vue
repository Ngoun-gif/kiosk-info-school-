            ...
            <div class="max-w-[720px]">
              ...
              <div class="mt-6">
                <button
                  ...
                  @click.stop="goToSlideDetail(slide.route)"
                >
...
import { courseSlides, type CourseSlideItem } from '@/data/slides/courseSlides'

type RenderSlide = CourseSlideItem & {
  _renderKey: string
}
...
function goToSlideDetail(route: string) {

    ...
    <section class="rounded-[28px] bg-white p-6 shadow-lg">
      <div class="flex items-center gap-2 text-sky-700">
        ...
        <p class="text-sm font-semibold uppercase tracking-[0.2em]">
          {{ internshipHero.eyebrow }}
        </p>
      </div>

      <h1 class="mt-2 text-3xl font-bold text-slate-900">
        {{ internshipHero.title }}
      </h1>

      <article class="mt-6 rounded-[24px] border border-slate-200 bg-white p-6 shadow-sm">
        <div class="flex items-start gap-4">
          ...
          <div class="min-w-0">
            ...
            <p class="mt-2 text-sm leading-7 text-slate-600">
              {{ internshipHero.description }}
            </p>

            <div class="mt-5 flex flex-wrap gap-3">
              <span
                v-for="badge in internshipHero.badges"
                :key="badge"
...
import { BriefcaseBusiness, CheckCircle2 } from 'lucide-vue-next'
import HeroCarouselInternship from '@/components/internship/HeroCarouselInternship.vue'
import InternshipTrackSection from '../internship/InternshipTrackSection.vue'
import {
  internshipHero,
  internshipStats,
  overviewParagraphs,
